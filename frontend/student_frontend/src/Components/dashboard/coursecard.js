...
export default function CourseCard(props) {
	...
	return (
		<div className="flex items-center justify-center h-auto shadow-2xl ">
			<Card
				className="w-96 h-56 bg-blue-200 rounded-lg text-white flex flex-col justify-between"
				actions={actions}
				hoverable>
				<p className=" uppercase text-base text-black text-center font-futura font-bold mb-4">{`${
