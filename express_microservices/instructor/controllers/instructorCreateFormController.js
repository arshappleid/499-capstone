...
router.post('/', async (req, res) => {
	try {
		...
		let form_visibility = req.body.sharefeedback;
		...
		const form_id = created_form.data.form_id;
		...
		return res.json({
			status: 'error',
			message:
				'error occured while parsing request in instructorCreateFormController.js: ' +
				e.message,
		});
	}
});
